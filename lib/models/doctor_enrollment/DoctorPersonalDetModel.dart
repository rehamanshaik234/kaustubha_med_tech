...
class DoctorPersonalDetModel {
  DoctorPersonalDetModel({
      String? legalName, 
      String? gender, 
      String? dateOfBirth, 
  ...
  DoctorPersonalDetModel.fromJson(dynamic json) {
...
DoctorPersonalDetModel copyWith({  String? legalName,
  String? gender,
  String? dateOfBirth,
  String? qualification,
  String? specialization,
  ...
  String? city,
  num? bookedAppointment,
}) => DoctorPersonalDetModel(  legalName: legalName ?? _legalName,
  ...
  Map<String, dynamic> toJson() {
    ...
    map['experienceYears'] = _experienceYears.toString();
    map['consultationFees'] = _consultationFees.toString();
