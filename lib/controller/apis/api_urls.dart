...
class ApiUrls{
  ...
  ///resetPassword
  static String sendResetPasswordEmailOtp='/auth/reset';
  static String sendResetPasswordPhoneOtp='/auth/reset-phone';
  static String verifyResetPasswordOtp='/auth/verify-otp';
  static String resetPassword='/auth/new-password';

  ///login
  static String logInWithEmailPwd='/auth/login/password-login';
  static String logInWithEmail='/auth/login/email-only-login';
