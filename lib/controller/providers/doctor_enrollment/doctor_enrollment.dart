...
class DoctorEnrollmentProvider extends ChangeNotifier{
  ...
  DoctorOfficialDetModel _officialDetModel = DoctorOfficialDetModel();
  DoctorOfficialDetModel get officialDetModel => _officialDetModel;
  ...
  void setOfficialDet(DoctorOfficialDetModel details)async{
  _officialDetModel=details;
    notifyListeners();
  }
