...
import 'package:kaustubha_medtech/views/screens/patient/chat/chat_screen.dart';
...
import 'package:kaustubha_medtech/views/screens/profile/children/patient_documents/patient_upload_document.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings,Function(String?) onPopRoute) {
    switch (settings.name) {
      ...
      case RoutesName.patientMain:
        ...
        case RoutesName.appointmentTimeSlot:
        return MaterialPageRoute(
            settings:settings,
            builder: (context)=>RouteAwareWidget(
              routeName: RoutesName.appointmentTimeSlot,
              onPop: onPopRoute,
        ...
        case RoutesName.contactList:
        return MaterialPageRoute(
            settings:settings,
            builder: (context)=>RouteAwareWidget(
              routeName: RoutesName.contactList,
              onPop: onPopRoute,
              child:  PatientContactList(),
            )
        );
      ...
      default:
        return DoctorRoutes.generateRoute(settings, onPopRoute);
    }
  }
}
