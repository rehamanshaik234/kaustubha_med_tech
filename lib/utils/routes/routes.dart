...
import 'package:kaustubha_medtech/views/screens/profile/children/help_support/help_support.dart';
import 'package:kaustubha_medtech/views/screens/profile/children/reviews/reviews_screen.dart';
import 'package:kaustubha_medtech/views/screens/profile/children/terms_and_conditions/terms_and_conditions.dart';
...
class Routes {
  static Route<dynamic> generateRoute(RouteSettings settings,Function(String?) onPopRoute) {
    switch (settings.name) {
      ...
      case RoutesName.verifyResetPasswordOtp:
        return MaterialPageRoute(
            settings:settings,
            builder: (context)=>RouteAwareWidget(
              routeName: RoutesName.verifyResetPasswordOtp,
              onPop: onPopRoute,
              child: const VerifyResetPasswordOtp(),
            )
        );
      ...
      case RoutesName.patientDocuments:
        ...
        return MaterialPageRoute(
            settings:settings,
            builder: (context)=>RouteAwareWidget(
              routeName: RoutesName.communityChat,
              onPop: onPopRoute,
        ...
        return MaterialPageRoute(
            settings:settings,
            builder: (context)=>RouteAwareWidget(
              routeName: RoutesName.helpAndSupport,
              onPop: onPopRoute,
              child: const HelpAndSupportScreen(),
            )
        );
        case RoutesName.selectVerificationType:
        return MaterialPageRoute(
            settings:settings,
            builder: (context)=>RouteAwareWidget(
              routeName: RoutesName.selectVerificationType,
              onPop: onPopRoute,
              child: const VerificationType(),
            )
        );
        ...
        return MaterialPageRoute(
            settings:settings,
            builder: (context)=>RouteAwareWidget(
              routeName: RoutesName.termsAndConditions,
              onPop: onPopRoute,
