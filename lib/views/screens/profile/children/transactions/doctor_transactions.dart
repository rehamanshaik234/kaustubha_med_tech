...
class DoctorTransactionsScreen extends StatefulWidget {
  ...
  @override
  State<DoctorTransactionsScreen> createState() => _DoctorTransactionsScreenState();
}
...
class _DoctorTransactionsScreenState extends State<DoctorTransactionsScreen> {
                    ...
                    child: Row(
                      ...
                      children: [
                        Visibility(
                            ...
                            child: Text(Constants.dateConverted(selectedDate),style: GoogleFonts.dmSans(fontWeight: FontWeight.w500,fontSize: 14.sp),)),
  ...
  void getTransactions({bool getAll=false}){
    context.read<TransactionsProvider>().getDoctorTransactions((r){},date: getAll?null:selectedDate);
  }
}
