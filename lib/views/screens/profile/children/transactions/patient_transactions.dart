...
class _PatientTransactionsScreenState extends State<PatientTransactionsScreen> {
                      ...
                      children: [
                        ...
                        TransactionDateDropdown(onChange: (val){
                          if(val==4){
                            ...
                            selectedDate=DateTime.now().subtract(const Duration(days: 1)).toString();
                            selectedTab=val;
                            setState(() {});
                            getTransactions();
                          }
  ...
  void getTransactions({bool getAll=false}){
    context.read<TransactionsProvider>().getPatientTransactions((r){},date: getAll? null: selectedDate);
  }
}
