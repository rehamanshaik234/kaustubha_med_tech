              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text("${verifiedEmail?? ""} ${verifiedNumber ?? ''}  ✅",style: GoogleFonts.inter(fontWeight: FontWeight.normal,fontSize: 14.sp)),
                    SizedBox(height: 30.h,),
                    ...
                    SizedBox(height: 30.h,),
                    CustomButton(onPressed: ()=>validateFields(), title: "Update",),
                  ],
                ),
              ),
            );
