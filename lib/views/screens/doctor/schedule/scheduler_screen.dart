...
class DoctorSchedulerScreen extends StatefulWidget {
  const DoctorSchedulerScreen({super.key});

  @override
  State<DoctorSchedulerScreen> createState() => _DoctorSchedulerScreenState();
}

class _DoctorSchedulerScreenState extends State<DoctorSchedulerScreen> with SingleTickerProviderStateMixin {
...
@override
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: CustomAppbar.patientAppBar(
          context,
