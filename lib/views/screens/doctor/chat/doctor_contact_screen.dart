...
import '../../../../models/chat/CommunityModel.dart';
import '../../../../utils/app_colors/app_colors.dart';
import '../../../../utils/constants/asset_urls.dart';
import '../../../widgets/custom_textfield.dart';
class DoctorContactList extends StatefulWidget {
  const DoctorContactList({super.key});

  @override
  State<DoctorContactList> createState() => _DoctorContactListState();
}

class _DoctorContactListState extends State<DoctorContactList> {
          ...
          return Column(
            children: [
              ...
              Row(
                children: [
                  Container(
                    width: provider.user.role!=Constants.patientRole && selectedOption==options[1]?1.sw-150.w:1.sw-27.w,
                  ...
                  Visibility(
                    visible: provider.user.role!=Constants.patientRole && selectedOption==options[1],
                      child: CustomButton(onPressed: (){
                        Navigator.of(context,rootNavigator: true).pushNamed(RoutesName.createCommunity);
                      }, title: "Create +",width: 120.w,)
                  )
                ],
              ),
              SizedBox(height: 8.h,),
