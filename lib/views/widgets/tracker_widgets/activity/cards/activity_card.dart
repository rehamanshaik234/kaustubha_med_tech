  ...
  Widget build(BuildContext context) {
    return Consumer<TrackerProvider>(
      builder: (context,provider,child) {
        num dailyPercentage=provider.tracker.tracks?.activity?.daily ?? 0.0;
        num weeklyPercentage=provider.tracker.tracks?.activity?.weekly ?? 0.0;
        num monthlyPercentage=provider.tracker.tracks?.activity?.monthly ?? 0.0;
        return Card(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text('Activity'.toUpperCase(),style: GoogleFonts.dmSans(color: Colors.black87,fontSize: 16.sp),),
