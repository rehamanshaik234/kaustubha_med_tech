...
class PatientAppointmentsTabBar extends StatelessWidget {
  late TabController tabController;

   PatientAppointmentsTabBar({super.key,required this.tabController});
  ...
  Widget build(BuildContext context) {
    return TabBar(
        ...
        tabs: [
          ...
          Padding(
            padding: EdgeInsets.only(bottom: 8.0.h),
            child: Text('Canceled',style: GoogleFonts.dmSans(color:  tabController.index==2 ? AppColors.primaryColor:Colors.black54,fontSize: 16.sp,fontWeight: FontWeight.w500),),
          ),
        ]);
  }
}
