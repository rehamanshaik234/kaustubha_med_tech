...
class DoctorPersonalDetailsState extends State<DoctorPersonalDetails> with AutomaticKeepAliveClientMixin {
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              Row(
                children:[
                  Text("Region",style: GoogleFonts.dmSans(fontWeight:FontWeight.w500,fontSize: 16.sp),),
                ],
              ),
              SizedBox(height: 8.h,),
  ...
  bool validateFields() {
    ...
    if (country==null || country?.isEmpty==true) {
    ...
    experienceYears: exp.text,consultationFees: consultFee.text, address: address.text,country: country,state: state,city: city,bookedAppointment: 0);
