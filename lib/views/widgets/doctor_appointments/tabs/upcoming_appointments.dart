...
class DoctorUpcomingAppointments extends StatefulWidget {
  const DoctorUpcomingAppointments({super.key});

  @override
  State<DoctorUpcomingAppointments> createState() => _DoctorUpcomingAppointmentsState();
}

class _DoctorUpcomingAppointmentsState extends State<DoctorUpcomingAppointments> {
            ...
            Row(
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image(image: appointmentInfo.patient?.image==null? AssetImage(AssetUrls.doctorProfile):NetworkImage(appointmentInfo.patient?.image ?? ''),
                    height: 100.sp,
                    width: 100.sp,
                    fit: BoxFit.cover, errorBuilder: (error,_,e){
                      return Image.asset(AssetUrls.profile);
                    },),
                ),
                SizedBox(width: 8.w,),
                Expanded(
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(appointmentInfo.patient?.name ?? "",style: GoogleFonts.inter(fontWeight: FontWeight.w700,fontSize: 16.sp),),
                      SizedBox(height: 8.h,),
                      Row(
                        children: [
                          SizedBox(
            ...
            Row(
              ...
              children: [
                ...
                CustomButton(onPressed: ()async{
                  ...
                  Navigator.of(context,rootNavigator: true).pushNamed(RoutesName.doctorAppointmentReschedule,arguments: {'date':appointmentInfo.date,'slot':appointmentInfo.time,'doctor_id':appointmentInfo.doctorId,'id':appointmentInfo.id});
  ...
  Future<void> getAppointments({bool? showPopUp})async{
   ...
   await provider.getUpcomingAppointments((r){
