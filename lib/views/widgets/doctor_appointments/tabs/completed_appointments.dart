            ...
            Row(
              ...
              children: [
                ClipRRect(
                    ...
                    child: Image(image: appointmentInfo.patient?.image!=null?NetworkImage(appointmentInfo.patient?.image) :AssetImage(AssetUrls.profile),height: 100.h,fit: BoxFit.cover,errorBuilder: (error,_,e){
