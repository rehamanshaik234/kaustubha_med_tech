...
class CustomTextField extends StatefulWidget {
  CustomTextField({super.key,required this.hintText,this.isPassword=false,this.inputType=TextInputType.text,
    ...
    this.outlinedBorder,this.includeSpacing,this.border,this.lines=1,this.outlineColor,this.fillColor,this.onTap,this.validator,this.suffix,this.textInputAction});
  String hintText;
  bool isPassword;
