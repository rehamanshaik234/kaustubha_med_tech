...
class ExperienceDropdown extends StatefulWidget {
  ...
  ExperienceDropdown({super.key,this.width});
...
class _ExperienceDropdownState extends State<ExperienceDropdown> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text("Experience",style: GoogleFonts.dmSans(fontWeight: FontWeight.w700,fontSize: 14.sp),),
        SizedBox(height: 8.h,),
        Consumer<PatientAppointmentProvider>(
          builder: (context,provider,_) {
            List<String> options=Constants.experiences;
            return Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        DropdownButton<String>(
                          value: provider.filterModel.experienceYears,
                          hint: SizedBox(
                              width: widget.width!=null ? 0.8.sw: null,
                              child: Text('Select Experience',style:GoogleFonts.inter(color: Colors.black54),)),
                          ...
                          onChanged: (value) {
                            if (value != null) {
                              provider.setFilter(experienceYears: value);
                            }
                          },
                        ...
                        Visibility(
                          visible: provider.filterModel.experienceYears!=null,
                          child: InkWell(
                              onTap: (){
                                provider.setFilter(resetExp: true,);
                              },
